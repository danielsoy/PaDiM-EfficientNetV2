...
def parse_args():
    ...
    parser.add_argument('-d', '--data_path', type=str, default='/content/Gdrive/MyDrive/MVTec_hazel')
    parser.add_argument('-s', '--save_path', type=str, default='/content/Gdrive/MyDrive/MVTec_hazel/mvtec_result')
